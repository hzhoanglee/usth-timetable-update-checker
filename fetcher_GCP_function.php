<?php
// Use for Google Cloud Function with require: google/cloud-functions-framework
use Google\CloudFunctions\FunctionsFramework;
use Psr\Http\Message\ServerRequestInterface;

FunctionsFramework::http('codeRun', 'codeRun');

function codeRun(ServerRequestInterface $request): string
{
